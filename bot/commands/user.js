...
async handleToggleNotifications(ctx) {
    ...
    async handleChangeCountry(ctx) {
        ...
        const countries = [
            ...
            { code: 'DE', name: '', name: '🇩🇪 Germany', flag: '🇩🇪' },
    ...
    async handleHelp(ctx) {
        const message =
            ...
            '2️⃣ Choose USDT or Naira\n' +
            '3️⃣ For USDT: Send USDT (BEP-20) to shown address\n' +
            '4️⃣ For Naira: Enter amount, pay via card/bank/USSD\n' +
            '5️⃣ Balance updates automatically\n\n' +
            '👑 <b>VIP Benefits:</b>\n' +
            '• 50 OTPs/day\n' +
            '• Priority routing\n' +
            '• Fastest delivery\n' +
